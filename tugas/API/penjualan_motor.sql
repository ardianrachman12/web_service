...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Okt 2022 pada 15.54
...
(1, 1, 'ardian rachman', '2022-04-01'),
(2, 2, 'jajang surajang', '2022-04-05'),
(3, 3, 'nuraini hidayati', '2022-05-02'),
(3, 4, 'nuraini hidayati', '2022-06-01'),
(5, 5, 'reza kurniawan', '2022-10-02');
...
--
ALTER TABLE `transaksi`
  MODIFY `id_trans` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `motor`
  ADD CONSTRAINT `motor_ibfk_1` FOREIGN KEY (`id_motor`) REFERENCES `stok` (`id_motor`);

--
-- Ketidakleluasaan untuk tabel `pembeli`
--
ALTER TABLE `pembeli`
  ADD CONSTRAINT `pembeli_ibfk_1` FOREIGN KEY (`id_trans`) REFERENCES `transaksi` (`id_trans`);
